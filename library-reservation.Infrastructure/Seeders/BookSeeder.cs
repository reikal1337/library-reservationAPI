    ...
    internal class BookSeeder(AppDbContext context) : IBookSeeder
    {
        ...
        private IEnumerable<Book> GetBooks()
        {
            List<Book> books = [
                ...
                new Book { Id = 4, Name = "One Hundred Years of Solitude", ImageSrc = "https://images.thegreatestbooks.org/fzce7ac1jcmx6fi8ppnea65ct3u9", Year = 1967, Types = new List<string>() { "book" } },
                new Book { Id = 5, Name = "The Catcher in the Rye", ImageSrc = "https://images.thegreatestbooks.org/azrr7j37ttxak2wmpmdoczhvd36t", Year = 1951, Types = new List<string>() { "book" } },
                ...
                new Book { Id = 9, Name = "Moby-Dick", ImageSrc = "https://images.thegreatestbooks.org/4zdrnqgrbobtunihoxvad8kxotot", Year = 1851, Types = new List<string>() { "book" } },
