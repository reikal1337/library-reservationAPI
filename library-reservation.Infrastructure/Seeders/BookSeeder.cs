    ...
    internal class BookSeeder(AppDbContext context) : IBookSeeder
    {
        ...
        private IEnumerable<Book> GetBooks()
        {
            List<Book> books = [
                ...
                new Book { Id = 6, Name = "Lolita", ImageSrc = "https://images.thegreatestbooks.org/t9epsngv7thxsjalsswqzgtnzlpu", Year = 1955, Type = new[] { "book" } },
                new Book { Id = 7, Name = "Nineteen Eighty Four", ImageSrc = "https://images.thegreatestbooks.org/oka7y4u1r23osldhnx42q9lvxtpz", Year = 1949, Type = new[] { "book" } },
                new Book { Id = 8, Name = "Anna Karenina", ImageSrc = "https://images.thegreatestbooks.org/m8kb7ah2lhy960dbp473zna11wb4", Year = 1877, Type = new[] { "book" } },
                new Book { Id = 9, Name = "Moby-Dick", ImageSrc = "https://images.thegreatestbooks.org/4zdrnqgrbobtunihoxvad8kxotot", Year = 1851, Type = new[] { "book" } },
                new Book { Id = 10, Name = "Wuthering Heights", ImageSrc = "https://images.thegreatestbooks.org/8lg4exp38r6236mjmp8nkx4k3k2j", Year = 1847, Type = new[] { "book" } },
                new Book { Id = 11, Name = "Pride and Prejudice", ImageSrc = "https://images.thegreatestbooks.org/hfiptkzo82hkprq8p4yfxoxb8pns", Year = 1813, Type = new[] { "book" } },
